...
int main(int argc, char* argv[])
{
    ...
    int Y_rows = 10;
    int Y_cols = 1;
    Matrix InImg_Y = weights_generator(Y_rows, Y_cols);
    ...
    Matrix loss = deviation(InImg_Y, final_output);
    PrintMatrix(loss, "loss"); 

    float theta = 1;
    Matrix updated_W2 = opium_lite(hidden_output, loss, W2, theta);
    PrintMatrix(updated_W2, "updated_W2");
