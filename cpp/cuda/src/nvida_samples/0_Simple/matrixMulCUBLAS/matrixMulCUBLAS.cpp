...
void initializeCUDA(int argc, char **argv, int &devID, int &iSizeMultiple, sMatrixSize &matrix_size)
{
    ...
    iSizeMultiple = min(iSizeMultiple, 50);
...
int matrixMultiply(int argc, char **argv, int devID, sMatrixSize &matrix_size)
{
    ...
    // CUBLAS version 2.0
    {
        ...
        printf("Performance= %.2f GFlop/s, Time= %.3f msec, Size= %.f Ops\n", gigaFlops,
                                                                              msecPerMatrixMul,
                                                                              flopsPerMatrixMul);
    ...
    if (resCUBLAS != true)
    {
        printfDiff(reference, h_CUBLAS, matrix_size.uiWC, matrix_size.uiHC, 100, 1.0e-5f);
    }
    ...
    */
    ...
    // It is also needed to ensure correct operatioin when the application is
    // being profiled. Calling cudaDeviceReset causes all profile data to be 
